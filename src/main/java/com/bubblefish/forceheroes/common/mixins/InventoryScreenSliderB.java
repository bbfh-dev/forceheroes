...
public class InventoryScreenSliderB extends SliderWidget {
    public InventoryScreenSliderB(int x, int y, int width, int height, Text text, double value) {
